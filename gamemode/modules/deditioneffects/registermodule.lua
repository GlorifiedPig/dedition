...
local folderName = "deditioneffects"
local moduleData = '{"folderName": "' .. folderName .. '", "loadPriority": 5,"author": "GlorifiedPig","description": "The Dedition heads up display.","website": "https://piggyis.pro/","version": "0.1", "loadPrefixes": {"server": "sv_", "client": "cl_", "shared": "sh_"}}'
